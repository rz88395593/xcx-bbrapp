// pages/bindManager/bindManager.js
const app = getApp();
Page({
      ...
      success: function (res) {
        ...
        wx.request({
          ...
          success: function (res) {
            ...
            that.setData({
              // showAddress: res.data.result.address_component.city,
              //  + res.data.result.address_component.district,
              locationData: res.data.result.ad_info.city
            });
          },
          fail: function () {
            // fail
  ...
  nextStep:function(){
    let json = ""
    // wx.navigateTo({
    //   url: '/pages/idcardOcr/idcardOcr' + '?jsonData=' + json,
    // })
  }
})